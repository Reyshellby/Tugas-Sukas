  ...
  return (
    <AdminLayout>
      ...
      <form className="bg-gray-900 p-6 rounded-xl border border-white/10 space-y-4">
        <input placeholder="Nama" className="w-full bg-gray-800 p-2 rounded" />
        <input placeholder="Email" className="w-full bg-gray-800 p-2 rounded" />
        <input placeholder="Password" type="password" className="w-full bg-gray-800 p-2 rounded" />
        <button className="bg-indigo-600 px-4 py-2 rounded">Register Admin</button>
      </form>
