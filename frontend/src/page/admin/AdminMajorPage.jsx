...
export default function AdminMajorPage() {
  return (
    <AdminLayout>
      <h1 className="text-2xl font-bold mb-6">Manajemen Jurusan</h1>

      <form className="bg-gray-900 p-6 rounded-xl border border-white/10 space-y-4">
        <input placeholder="Nama Jurusan" className="w-full bg-gray-800 p-2 rounded" />
        <button className="bg-indigo-600 px-4 py-2 rounded">Tambah Jurusan</button>
      </form>
